    ...
    <section id="featured" className="scroll-mt-28 bg-night py-12 sm:py-16">
      <div className="container-page">
        <div className="mb-9 flex flex-wrap items-end justify-between gap-4">
          <div>
            <p className="eyebrow-dark text-[10px] sm:text-xs">Made to wear</p>
            <h2 className="mt-1 text-2xl text-white sm:text-3xl md:text-4xl">Popular prints</h2>
            <p className="mt-2 max-w-lg text-sm leading-relaxed text-night-ink sm:mt-3 sm:text-base">
              Custom printed tees, matching looks and thoughtful gifts, made for everyday stories.
            </p>
          </div>
          <Link
            href="/category"
          ...
          >
            Shop all prints <ArrowRightIcon className="h-4 w-4" />
          </Link>
        </div>
