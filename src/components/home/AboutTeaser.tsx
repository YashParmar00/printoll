      ...
      <div className="container-page relative grid items-center gap-10 lg:grid-cols-[1.3fr_1fr]">
        <div>
          ...
          <h2 className="mt-2 text-2xl text-white sm:text-3xl md:mt-3 md:text-4xl">
            Made personal, by a small team in India
          </h2>
          <p className="mt-3 max-w-xl text-sm leading-relaxed text-night-ink sm:mt-4 sm:text-base">
            {site.name} started with one idea: custom prints should feel personal, not generic. So we
            make small runs on good cotton, with artwork and details you&apos;ll actually want to wear or gift.
            We&apos;re always a WhatsApp message away,{" "}
            {site.supportHours}.
          </p>
