...
export default function ShippingPolicyPage() {
  return (
    <PageShell eyebrow="Policies" title="Shipping Policy" updated="26 July 2026">
      <p>
        We ship across India. Because most of our gifts are personalized and made to order, here is
        exactly what to expect after you place an order.
      </p>

      <h2>Processing & delivery time</h2>
      <p>
        Personalized items are crafted after you order, so please allow a little time for making. Most
      ...
      <p>Shipping is <strong>free</strong> on all orders across India — no minimum.</p>
      ...
      <p className="text-sm">
        <em>This policy is a starting template for AuraaMarts and should be reviewed for your final
        launch details.</em>
      </p>
    </PageShell>
  );
